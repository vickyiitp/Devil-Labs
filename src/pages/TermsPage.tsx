    ...
    <div className="min-h-screen bg-white text-stone-600 font-mono p-6 sm:p-12 relative z-10 pt-32">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="text-stone-900 text-3xl font-display font-extrabold tracking-tight uppercase">Terms of Service</h1>
        </div>
        <p className="text-xs mb-12 border-b border-stone-200 pb-6 text-violet-400 font-bold tracking-widest">EFFECTIVE DATE: 2026-07-10</p>
        
        <div className="space-y-12 text-sm leading-relaxed max-w-3xl">
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 1. ACCEPTANCE OF TERMS</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 2. SCOPE OF SERVICES & PLANS</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 3. PRICING & PAYMENT TERMS</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 5. INTELLECTUAL PROPERTY RIGHTS</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 6. WARRANTIES & LIABILITIES</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 6. TERMINATION</h2>
            <p>
