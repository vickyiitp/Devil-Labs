...
export default function ServicesPage({ navigate }: ServicesPageProps) {
  ...
  return (
    <div id="services-page-root" className="pt-20 xs:pt-24 sm:pt-28 lg:pt-32 pb-24 px-4 md:px-8 max-w-7xl mx-auto text-stone-800">
      {/* 1. HEADER */}
      <section id="services-header" className="mb-20 space-y-4">
        <span className="text-violet-600 font-sans text-xs uppercase tracking-widest font-extrabold">✦ OUR CAPABILITIES</span>
        <h1 className="font-display font-extrabold text-3xl xs:text-4xl sm:text-6xl md:text-7xl text-stone-800 tracking-tighter uppercase leading-none break-words max-w-full">
          OUR SERVICES &amp;<br className="sm:hidden" /> CAPABILITIES.
        </h1>
        ...
        {serviceCategories.map((category, catIdx) => (
          <div key={category.id} className="relative">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-stone-200/30 pb-6">
              <div>
                <span className="text-violet-600 font-sans text-xs uppercase tracking-widest font-extrabold block mb-2">
              ...
              {category.items.map((service, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group p-6 md:p-8 flex flex-col justify-between cursor-pointer hover:border-violet-300/40 hover:scale-[1.025] relative overflow-hidden text-left clay-card"
                  >
        ...
        <section className="mb-28 p-6 md:p-8 clay-card relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 mb-10 pb-6 border-b border-stone-200/30">
            <div className="space-y-2">
              <span className="text-violet-600 font-sans text-[10px] uppercase tracking-widest font-extrabold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6">
            {[
              ...
              <div
                key={item.id}
                className="p-6 md:p-8 relative group flex flex-col justify-between clay-card hover:border-violet-300/40 hover:scale-[1.03]"
              >
      ...
      <ScrollReveal delay={100}>
        <section id="tech-stack-deep-dive-section" className="py-24 border-t border-stone-200/30">
          <div className="text-center space-y-4 mb-16">
            <span className="text-violet-600 font-sans text-xs uppercase tracking-widest font-extrabold">✦ PRODUCTION TOOLKIT</span>
            <h2 className="font-display font-extrabold text-4xl sm:text-5xl text-stone-800 tracking-tight uppercase">OUR TECHNOLOGY STACK.</h2>
            ...
            {tools.map((tool) => {
              ...
              return (
                <div
                  ...
                  key={tool.name}
                  className="p-6 md:p-8 transition-all duration-300 flex flex-col justify-between group clay-card hover:border-violet-300/30 hover:scale-[1.03]"
                >
                  <div className="space-y-4">
                  ...
                  <div className="mt-6 border-t border-stone-200/20 pt-4 text-[10px] font-sans font-bold text-stone-400 uppercase tracking-widest">
                    PRODUCTION-READY
                  </div>
                </div>
              );
      ...
      <ScrollReveal delay={150}>
        <section id="services-cta-section" className="clay-card p-6 md:p-8 flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto mt-24">
          <span className="text-violet-600 font-sans text-xs uppercase tracking-widest font-extrabold">✦ GET STARTED TODAY</span>
          <h2 className="font-display font-extrabold text-3xl sm:text-5xl text-stone-800 uppercase tracking-tighter leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-rose-500">Let's discuss your vision.</span>
          </h2>
          <p className="text-stone-600 text-sm max-w-md leading-relaxed font-sans">
