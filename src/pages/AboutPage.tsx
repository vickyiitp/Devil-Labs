  ...
  return (
    <div className="pt-12 sm:pt-16 lg:pt-20 pb-24 px-4 md:px-8 max-w-7xl mx-auto min-h-screen text-stone-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 relative z-10 items-start">
        ...
        <div className="lg:col-span-7 space-y-12 font-mono text-sm uppercase tracking-widest leading-relaxed text-stone-300">
          <ScrollReveal>
            <p className="mb-6 text-stone-100 font-bold text-base">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <div className="relative group shrink-0 mt-2">
                ...
                <BlurredImage 
                  ...
                  loading="lazy"
                  className="w-24 h-24 md:w-32 md:h-32 rounded-3xl border border-white/10 relative z-10 shadow-sm"
                />
              </div>
              <div>
                ...
                <p className="mb-6 text-xs normal-case text-stone-400 leading-loose">
                ...
                <p className="text-xs normal-case text-stone-400 leading-loose">
          ...
          <ScrollReveal delay={250}>
            <div className="pt-8 border-t border-white/10/50">
              <h3 className="text-stone-100 font-bold mb-6 text-sm">Core Statistics</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 text-left">
                <div>
                  <div className="text-3xl font-display font-black text-stone-100">#1</div>
                  <div className="text-xs text-stone-400 mt-1 font-mono tracking-widest uppercase">IN BIHAR FOR TECH SERVICES</div>
                </div>
                <div>
                  <div className="text-3xl font-display font-black text-stone-100">100+</div>
                  <div className="text-xs text-stone-400 mt-1 font-mono tracking-widest uppercase">ARCHITECTURES DEPLOYED</div>
                </div>
                <div>
                  <div className="text-3xl font-display font-black text-stone-100">24/7</div>
                  <div className="text-xs text-stone-400 mt-1 font-mono tracking-widest uppercase">SYSTEM MONITORING</div>
                </div>
                <div>
                  <div className="text-3xl font-display font-black text-stone-100">0</div>
          ...
          <ScrollReveal delay={300}>
            <div className="pt-8 border-t border-white/10">
              <h3 className="text-stone-100 font-bold mb-6 text-sm">ARCHITECTURAL MANIFESTO</h3>
              <div className="space-y-6">
                <div className="p-6 md:p-8 clay-card bg-[#0a0a0a] border border-white/10 rounded-[24px]">
                  <h4 className="text-xs font-black text-violet-400 tracking-wider uppercase mb-1">01 / TYPESAFE DETERMINISM</h4>
                  <p className="text-xs text-stone-400 normal-case leading-relaxed font-sans">
                ...
                <div className="p-6 md:p-8 clay-card bg-[#0a0a0a] border border-white/10 rounded-[24px]">
                  <h4 className="text-xs font-black text-violet-400 tracking-wider uppercase mb-1">02 / HYPER-OPTIMIZED EDGE SPEED</h4>
                  <p className="text-xs text-stone-400 normal-case leading-relaxed font-sans">
                ...
                <div className="p-6 md:p-8 clay-card bg-[#0a0a0a] border border-white/10 rounded-[24px]">
                  <h4 className="text-xs font-black text-violet-400 tracking-wider uppercase mb-1">03 / ZERO-TRUST ENVELOPE PROTECTION</h4>
                  <p className="text-xs text-stone-400 normal-case leading-relaxed font-sans">
        ...
        <div className="lg:col-span-5 space-y-8">
          <ScrollReveal delay={200}>
            <div className="p-6 md:p-8 clay-card flex flex-col space-y-8 text-left">
              ...
              <span className="font-display text-stone-100 text-lg font-black tracking-widest mt-2">DEVIL LABS</span>
              <span className="text-xs text-stone-400 tracking-[0.3em] font-mono mt-1">SECURE LAB IDENTIFIER</span>
              </div>

              <div>
                <h3 className="text-stone-100 font-mono text-xs uppercase tracking-widest font-bold mb-4 flex items-center gap-2">
                  <MapPin size={14} className="text-violet-400" />
                  Headquarters
                </h3>
                <p className="font-mono text-stone-400 text-xs uppercase tracking-widest leading-loose">
                  Devil Labs<br/>
                  Gaya, Bihar<br/>
                  India (Sector 01)
                </p>
              ...
              <div className="pt-8 border-t border-white/10/30">
                ...
                <ul className="space-y-4 font-mono text-xs text-stone-400 uppercase tracking-widest">
              ...
              <div className="pt-8 border-t border-white/10/30">
                ...
                <div className="space-y-3 font-mono text-xs uppercase tracking-widest font-bold">
                  <a href="https://instagram.com/devillabs" target="_blank" rel="noreferrer" className="flex items-center justify-between group text-stone-300 hover:text-stone-100 transition-all clay-button p-4.5 rounded-2xl">
                    <span>Instagram</span>
                    <ArrowUpRight size={14} className="text-violet-400 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                  </a>
                  <a href="https://linkedin.com/company/devillabs" target="_blank" rel="noreferrer" className="flex items-center justify-between group text-stone-300 hover:text-stone-100 transition-all clay-button p-4.5 rounded-2xl">
                    <span>LinkedIn</span>
                    <ArrowUpRight size={14} className="text-violet-400 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                  </a>
                  <a href="https://github.com/Devil-Labs/" target="_blank" rel="noreferrer" className="flex items-center justify-between group text-stone-300 hover:text-stone-100 transition-all clay-button p-4.5 rounded-2xl">
                    <span>GitHub Organization</span>
                    <ArrowUpRight size={14} className="text-violet-400 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" />
                  </a>
                  <a href="https://vickyiitp.tech" target="_blank" rel="noreferrer" className="flex items-center justify-between group text-stone-300 hover:text-stone-100 transition-all clay-button p-4.5 rounded-2xl">
