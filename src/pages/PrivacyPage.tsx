...
export default function PrivacyPage({ navigate }: { navigate: (path: string) => void }) {
  return (
    <div className="min-h-screen bg-white text-stone-600 font-mono p-6 sm:p-12 relative z-10 pt-32">
      <div className="max-w-4xl mx-auto">
        <button 
          onClick={() => navigate('/')}
          className="flex items-center space-x-2 text-xs hover:text-stone-900 transition-colors mb-12"
        >
          <ArrowLeft size={14} />
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="text-stone-900 text-3xl font-display font-extrabold tracking-tight uppercase">Privacy Policy & Data Processing</h1>
        </div>
        <p className="text-xs mb-12 border-b border-stone-200 pb-6 text-violet-400 font-bold tracking-widest">EFFECTIVE DATE: 2026-07-10 | COMPLIANT WITH GDPR, CCPA, & INDIAN IT ACT (2000)</p>
        
        <div className="space-y-12 text-sm leading-relaxed max-w-3xl">
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 1. INTRODUCTION & SCOPE</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 2. INFORMATION WE COLLECT</h2>
            <p className="mb-3">We collect information strictly necessary for the execution of our services:</p>
            <ul className="list-disc pl-5 space-y-2 text-gray-300">
              <li><strong className="text-stone-900">Client Identity & Billing:</strong> Names, corporate entities, GST/Tax IDs, billing addresses, and payment processing details.</li>
              <li><strong className="text-stone-900">Technical Infrastructure Data:</strong> API keys, server credentials, database dumps, and source code required for project development and deployment.</li>
              <li><strong className="text-stone-900">Telemetry & Usage Data:</strong> Anonymized interaction logs from our web properties to improve user experience.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 3. DATA PROCESSING & USAGE</h2>
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 4. DATA SHARING & SUB-PROCESSORS</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 5. SECURITY PROTOCOLS</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 6. YOUR RIGHTS (GDPR & CCPA)</h2>
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 7. CONTACT THE DPO</h2>
            <p>
              For any privacy concerns, data deletion requests, or NDA inquiries, please contact our Data Protection Officer at: <br/>
              <strong className="text-stone-900">legal@devillabs.co</strong> or <strong className="text-stone-900">+91 81020 99678</strong>.
            </p>
          </section>
        </div>
      </div>
