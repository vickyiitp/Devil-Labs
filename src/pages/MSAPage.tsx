    ...
    <div className="min-h-screen bg-white text-stone-600 font-mono p-6 sm:p-12 relative z-10 pt-32">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center space-x-4 mb-6">
          ...
          <h1 className="text-stone-900 text-3xl font-display font-extrabold tracking-tight uppercase">Master Services Agreement (MSA) & NDA</h1>
        </div>
        <p className="text-xs mb-12 border-b border-stone-200 pb-6 text-violet-400 font-bold tracking-widest">STANDARD ENTERPRISE TEMPLATE</p>
        
        <div className="space-y-12 text-sm leading-relaxed max-w-3xl">
          
          <div className="bg-stone-50 border border-stone-200 p-6 rounded-lg text-stone-900 font-sans text-base mb-8">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 1. NON-DISCLOSURE AGREEMENT (NDA) PROTOCOL</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 2. STATEMENTS OF WORK (SOW)</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 3. ACCEPTANCE & TESTING</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 4. MAINTENANCE & SERVICE LEVEL AGREEMENT (SLA)</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-stone-900 text-lg font-bold mb-4 uppercase tracking-wider">✦ 5. INDEPENDENT CONTRACTOR STATUS</h2>
            <p className="mb-4">
