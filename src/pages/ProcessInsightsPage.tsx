...
export default function ProcessInsightsPage({ navigate }: ProcessInsightsPageProps) {
  ...
  return (
    <div className="pt-20 xs:pt-24 sm:pt-28 lg:pt-32 pb-24 px-4 md:px-8 max-w-7xl mx-auto min-h-screen text-stone-100 relative">
      ...
      >
        <div className="inline-flex items-center space-x-2 bg-violet-100 border border-violet-200/50 px-4 py-1.5 rounded-full text-xs font-bold text-violet-400 mb-6 uppercase tracking-widest shadow-sm">
      ...
      >
        <div className="clay-card p-6 md:p-8 relative overflow-hidden group hover:scale-[1.02] transition-all text-left">
          ...
          <div className="text-xl md:text-2xl font-black text-stone-100 tracking-tight font-mono">
            {agentSpeed}% <span className="text-xs text-emerald-600 font-bold">MAX</span>
          </div>
          <div className="w-full bg-white/10/50 h-1 rounded-full mt-3 overflow-hidden">
            <motion.div 
      ...
      <div className="flex justify-center mb-12">
        <div className="inline-flex p-1.5 bg-[#f0ede6] border border-white/10 rounded-2xl shadow-inner font-mono">
          <button
            onClick={() => setActiveTab('all')}
            className={`px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
              activeTab === 'all'
                ? 'bg-[#0d0d12] text-stone-100 shadow-md font-black'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-7xl mx-auto">
        ...
        {(activeTab === 'all' || activeTab === 'process') && (
          ...
          >
            <div className="border-b border-white/10/30 pb-4 mb-8 flex items-center justify-between">
              <div className="text-left">
                <span className="text-xs text-violet-600 font-mono font-bold block">✦ DEPLOYMENT PIPELINE</span>
                <h2 className="text-2xl font-display font-extrabold text-stone-100 uppercase tracking-tight">The Engine Room</h2>
              </div>
              <span className="text-xs text-stone-400 font-mono uppercase tracking-widest bg-[#050505]/80 border border-white/10 px-3 py-1.5 rounded-full shadow-sm font-bold">
                4-Phase Sequence
              </span>
            </div>

            {/* Steps Timeline Grid */}
            <div className="space-y-6 relative pl-6 border-l border-white/10 text-left">
              {steps.map((step) => (
                <div key={step.id} className="relative group">
                  {/* Indicator Dot */}
                  <div className="absolute -left-[31px] top-2 w-2 h-2 rounded-full bg-[#0d0d12] border-2 border-violet-600 group-hover:bg-violet-400 transition-colors z-10" />
                  
                  <div className="p-6 md:p-8 clay-card hover:scale-[1.01] hover:border-violet-300 transition-all relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-12 h-12 bg-[#111]/80 flex items-center justify-center font-mono font-bold text-stone-400 select-none text-base border-l border-b border-white/10/20">
                      {step.id}
                    </div>
                    <span className="text-xs text-violet-600 font-mono tracking-widest uppercase block mb-1 font-bold">PHASE {step.id}</span>
                    <h3 className="text-stone-100 font-extrabold uppercase tracking-tight text-sm group-hover:text-violet-600 transition-colors mb-2">
                      {step.title}
                    </h3>
                    <p className="text-xs text-stone-400 leading-relaxed max-w-md font-sans font-light">
                      {step.desc}
                    </p>
                  </div>
                </div>
            ...
            <div className="pt-8 border-t border-white/10/30 text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                <div className="p-5 bg-[#0d0d12] border border-white/10 rounded-2xl hover:border-violet-300 shadow-sm transition-all">
                  <Zap className="text-violet-600 mb-3 animate-pulse" size={16} />
                  <h4 className="text-stone-100 text-xs font-bold uppercase mb-1">AI Speed</h4>
                ...
                <div className="p-5 bg-[#0d0d12] border border-white/10 rounded-2xl hover:border-violet-300 shadow-sm transition-all">
                  ...
                  <h4 className="text-stone-100 text-xs font-bold uppercase mb-1">Zero Debt</h4>
                  <p className="text-xs text-stone-400 leading-relaxed font-sans font-light">
                ...
                <div className="p-5 bg-[#0d0d12] border border-white/10 rounded-2xl hover:border-violet-300 shadow-sm transition-all">
                  ...
                  <h4 className="text-stone-100 text-xs font-bold uppercase mb-1">Hardened</h4>
                  <p className="text-xs text-stone-400 leading-relaxed font-sans font-light">
          ...
          >
            <div className="border-b border-white/10/30 pb-4 mb-8 flex items-center justify-between">
              <div className="text-left">
                ...
                <h2 className="text-2xl font-display font-extrabold text-stone-100 uppercase tracking-tight">Lab Notes</h2>
              </div>
              <span className="text-xs text-stone-400 font-mono uppercase tracking-widest bg-[#050505]/80 border border-white/10 px-3 py-1.5 rounded-full shadow-sm font-bold">
                Telemetry Releases
              </span>
            ...
            <div className="clay-card p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center py-6">
                ...
                <p className="text-xs text-stone-400 leading-relaxed max-w-sm mx-auto font-sans font-light">
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="max-w-7xl mx-auto mt-24 pt-20 border-t border-white/10/30"
      >
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-display font-extrabold text-stone-100 uppercase tracking-tight">Active Node Transmissions</h2>
          <p className="text-stone-400 max-w-xl mx-auto mt-3 text-xs leading-relaxed font-sans font-light">
              ...
              <div className="p-6 md:p-8 clay-card hover:scale-[1.01] hover:border-violet-300 transition-all flex flex-col justify-between h-full text-left">
                <div>
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-xs font-mono text-stone-400 font-bold tracking-wider bg-[#111] border border-white/10/20 px-2 py-0.5 rounded uppercase">
                      {t.metric}
                    </span>
                  </div>
                  ...
                  <div className="relative mb-6">
                    ...
                    <p className="text-xs text-stone-300 leading-relaxed font-sans relative z-10 pl-4 font-light">
                      {t.quote}
                    </p>
                  </div>
                </div>

                <div className="border-t border-white/10/30 pt-4 mt-4">
                  <p className="text-stone-100 font-mono text-xs font-bold uppercase">{t.author}</p>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-300 italic font-sans leading-relaxed font-light">
              ...
              <p className="text-xs text-stone-400 font-mono">
                — Vicky IITP, Founder & Lead Architect at <span className="text-stone-100 font-bold">vickyiitp.tech</span>
              </p>
            </div>
            <button 
      ...
      <AnimatePresence>
        {selectedArticle !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/20/30 backdrop-blur-md">
            ...
            >
              <div className="clay-card bg-[#0a0a0a] p-6 md:p-8 flex flex-col relative max-h-[85vh] overflow-y-auto text-left shadow-2xl">
                {(() => {
                  const art = articles.find(a => a.id === selectedArticle);
                  if (!art) return null;
                  return (
                    <>
                      <div className="flex items-center justify-between border-b border-white/10/30 pb-4 mb-6">
                        ...
                        <button 
                          ...
                          className="text-stone-400 hover:text-stone-100 text-xs font-mono font-bold flex items-center space-x-1.5 clay-button px-3 py-1.5"
                        >
                          <X size={12} />
                          <span>CLOSE</span>
                        </button>
                      ...
                      <h2 className="text-xl md:text-2xl font-display font-extrabold text-stone-100 uppercase tracking-tight mb-4">
                        {art.title}
                      </h2>
                      
                      <p className="text-xs text-stone-300 leading-relaxed font-sans mb-6 font-light">
                        {art.content}
                      </p>

                      <div className="border-t border-white/10/30 pt-4 mt-auto flex items-center justify-between font-mono">
      ...
      <div className="clay-card py-12 px-6 max-w-4xl mx-auto mt-24 text-left p-6 md:p-8">
        ...
        >
          ...
          <input 
            ...
            className="bg-transparent border-none text-stone-100 focus:outline-none focus:ring-0 placeholder-stone-300 flex-grow min-w-[200px]"
          />
          <button type="submit" className="text-stone-300 hover:text-violet-600 font-bold transition-colors shrink-0 clay-button px-5 py-2 text-xs">
            [CONNECT]
          </button>
        </form>
      </div>
