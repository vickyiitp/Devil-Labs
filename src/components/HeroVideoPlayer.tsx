...
export default function HeroVideoPlayer() {
  ...
  return (
    <div className="w-full max-w-full h-full relative rounded-2xl overflow-hidden bg-white border border-white/10 flex items-center justify-center shadow-2xl group">
      
      {!loaded && (
        <div className="absolute inset-0 bg-white z-10 p-6 flex flex-col justify-end max-w-full">
