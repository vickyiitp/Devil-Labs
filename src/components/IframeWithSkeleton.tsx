    ...
    <div className="absolute inset-0 w-full h-full bg-[#050505]">
      ...
      {!loaded && (
        <div className="absolute inset-0 p-8 flex flex-col space-y-6 z-0">
          ...
          <div className="w-1/3 h-12 bg-[#050505]/5 border border-white/10 rounded-sm" />
          <div className="w-full h-6 bg-[#050505]/5 border border-white/10 rounded-sm" />
          <div className="w-5/6 h-6 bg-[#050505]/5 border border-white/10 rounded-sm" />
          
          <div className="grid grid-cols-2 gap-4 pt-12">
             <div className="aspect-video bg-[#050505]/5 border border-white/10 rounded-sm" />
             <div className="aspect-video bg-[#050505]/5 border border-white/10 rounded-sm" />
          </div>
        </div>
      )}
      ...
      <div className="absolute top-0 left-0 w-[400%] h-[400%] origin-top-left pointer-events-none z-10" style={{ transform: 'scale(0.25)' }}>
        <iframe 
          src={src} 
          className={`w-full h-full border-none bg-[#050505] transition-opacity duration-700 ${loaded ? 'opacity-100' : 'opacity-0'}`}
