...
export default function BentoGrid({ onNavigateContact }: { onNavigateContact: () => void }) {
  ...
  return (
    <div id="bento-box-grid-root" className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 text-stone-100 max-w-sm md:max-w-2xl xl:max-w-none mx-auto">
      ...
      >
        ...
        <div className="flex justify-between items-start text-left">
          <div className="space-y-1 font-mono">
            <span className="text-[10px] tracking-widest text-violet-400 font-bold uppercase">{projects[0].subtitle}</span>
            <h3 className="font-display font-extrabold text-2xl sm:text-3xl text-stone-100 tracking-tight">{projects[0].title}</h3>
          </div>
          <div className="p-3 bg-[#0a0a0a]/80 border border-white/10 rounded-xl group-hover:border-violet-400 group-hover:bg-violet-900/40 transition-colors duration-300 shadow-sm">
            <Cpu className="text-stone-400 group-hover:text-violet-300 transition-colors duration-300" size={20} />
          </div>
        </div>

        <p className="text-stone-300 font-sans text-xs sm:text-sm mt-6 mb-8 leading-relaxed max-w-xl text-left normal-case">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-t border-white/10 pt-6">
          <div className="flex flex-wrap gap-2">
            {projects[0].tags.map((tag) => (
              <span key={tag} className="px-2.5 py-1 bg-[#0a0a0a]/80 border border-white/10 text-[10px] font-mono text-stone-400 rounded-full uppercase shadow-xs">
                {tag}
              </span>
            ))}
          </div>
          <div className="text-right font-mono">
            <div className="text-3xl font-display font-black text-stone-100 tracking-tighter">{projects[0].stat}</div>
      ...
      <motion.div
        ...
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.98 }}
        className="relative overflow-hidden flex flex-col justify-between group cursor-pointer interactive-clay-card hover:border-blue-400/40 p-6 md:p-8"
      ...
      >
        ...
        <div className="flex justify-between items-start text-left">
          <div className="space-y-1 font-mono">
            <span className="text-[10px] tracking-widest text-blue-400 font-bold uppercase">{projects[1].subtitle}</span>
            <h3 className="font-display font-extrabold text-2xl text-stone-100 tracking-tight">{projects[1].title}</h3>
          </div>
          <div className="p-3 bg-[#0a0a0a]/80 border border-white/10 rounded-xl group-hover:border-blue-400 group-hover:bg-blue-900/40 transition-colors duration-300 shadow-sm">
            <Server className="text-stone-400 group-hover:text-blue-300 transition-colors duration-300" size={20} />
          </div>
        </div>

        <p className="text-stone-300 font-sans text-xs sm:text-sm mt-6 mb-8 leading-relaxed text-left normal-case">
        ...
        <div className="flex items-end justify-between border-t border-white/10 pt-6 font-mono">
          <div className="flex flex-wrap gap-2 max-w-[150px]">
            {projects[1].tags.slice(0, 2).map((tag) => (
              <span key={tag} className="px-2.5 py-1 bg-[#0a0a0a]/80 border border-white/10 text-[10px] text-stone-400 rounded-full uppercase shadow-xs">
                {tag}
              </span>
            ))}
          </div>
          <div className="text-right">
            <div className="text-3xl font-display font-black text-stone-100 tracking-tighter">{projects[1].stat}</div>
      ...
      <motion.div
        ...
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.98 }}
        className="relative overflow-hidden flex flex-col justify-between group cursor-pointer interactive-clay-card hover:border-fuchsia-400/40 p-6 md:p-8"
      ...
      >
        ...
        <div className="flex justify-between items-start text-left">
          <div className="space-y-1 font-mono">
            <span className="text-[10px] tracking-widest text-fuchsia-400 font-bold uppercase">{projects[2].subtitle}</span>
            <h3 className="font-display font-extrabold text-2xl text-stone-100 tracking-tight">{projects[2].title}</h3>
          </div>
          <div className="p-3 bg-[#0a0a0a]/80 border border-white/10 rounded-xl group-hover:border-fuchsia-400 group-hover:bg-fuchsia-900/40 transition-colors duration-300 shadow-sm">
            <Sparkles className="text-stone-400 group-hover:text-fuchsia-300 transition-colors duration-300" size={20} />
          </div>
        </div>
        ...
        <div className="flex items-end justify-between border-t border-white/10 pt-6 font-mono">
          ...
          <div className="text-right">
            <div className="text-3xl font-display font-black text-stone-100 tracking-tighter">{projects[2].stat}</div>
      ...
      <motion.div
        ...
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.98 }}
        className="md:col-span-2 relative overflow-hidden flex flex-col justify-between group cursor-pointer interactive-clay-card hover:border-emerald-400/40 p-6 md:p-8"
      ...
      >
        ...
        <div className="flex justify-between items-start text-left">
          <div className="space-y-1 font-mono">
            <span className="text-[10px] tracking-widest text-emerald-400 font-bold uppercase">{projects[3].subtitle}</span>
            <h3 className="font-display font-extrabold text-2xl sm:text-3xl text-stone-100 tracking-tight">{projects[3].title}</h3>
          </div>
          <div className="p-3 bg-[#0a0a0a]/80 border border-white/10 rounded-xl group-hover:border-emerald-400 group-hover:bg-emerald-900/40 transition-colors duration-300 shadow-sm">
            <MessageSquare className="text-stone-400 group-hover:text-emerald-300 transition-colors duration-300" size={20} />
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-t border-white/10 pt-6">
          ...
          <div className="text-right font-mono">
            <div className="text-3xl font-display font-black text-stone-100 tracking-tighter">{projects[3].stat}</div>
